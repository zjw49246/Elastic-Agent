...
| **[audiobook-nonfiction](https://github.com/zjw49246/audiobook-nonfiction)** | Claude Code 有声书插件：10 Phase 生产流水线、22 个子 Agent、/audiobook 命令。**不做改造**，保持与产品经理 ZIP 包一致，适配逻辑在 ABS 侧 | Claude Code Skill | 安装在 Worker 上 |
